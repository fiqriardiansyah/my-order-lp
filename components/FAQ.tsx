...
const items: FAQItem[] = [
  ...
  },
  {
    ...
    aId: 'Bisa, mulai dari paket Bisnis. Setiap outlet punya menu, meja, dan staff sendiri, tapi owner tetap bisa lihat report semua outlet dari satu dashboard.',
    aEn: 'Yes, starting from the Business plan. Each outlet has its own menu, tables, and staff, but the owner can see reports across all outlets from one dashboard.',
  },
  {
  ...
  {
    qId: 'Apakah ada masa percobaan gratis?',
    qEn: 'Is there a free trial?',
    aId: 'Ada. Paket Pro bisa dicoba 14 hari gratis tanpa kartu kredit. Atau kamu bisa langsung pakai paket Gratis selamanya untuk sampai 3 meja.',
    aEn: 'Yes. The Pro plan is free for 14 days, no credit card required. Or use the Free plan forever for up to 3 tables.',
  },
];
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) minmax(0, 2fr)', gap: 56, alignItems: 'start' }}>
          <div style={{ position: 'sticky', top: 96 }} className="faq-aside">
            ...
            <h2 className="h-section">
              {lang === 'id' ? 'Pertanyaan yang sering ditanya.' : 'Questions, answered.'}
            </h2>
